...
// every rule file under rules/ is registered here and every registered rule
// maps to >=1 requirement — the traps.md registration-completeness pattern, so
// a rule file that is never wired in fails CI instead of silently not running.
export const ALL_RULES: AnyRule[] = [art50AiInteraction];
